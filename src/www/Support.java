...
public class Support {
	...
	s.addrp("Trek", RepairLevel.silver, 40, 4);
                ...
                //s.addc("John", "Smith");
                s.addo(0, new Date(3, 3, 2019), "Trek", RepairLevel.silver, "no comment");
                s.addo(0, new Date(3, 4, 2019), "Cannondale", RepairLevel.gold, "no comment");
                s.addo(0, new Date(3, 5, 2019), "Salsa", RepairLevel.platinum, "no comment");
                //s.addc("Susan", "Apples");
                s.addo(1, new Date(3, 6, 2019), "Jamis", RepairLevel.silver, "no comment");
                s.addo(1, new Date(3, 7, 2019), "Trek", RepairLevel.gold, "no comment");
                s.addo(1, new Date(3, 8, 2019), "Cannondale", RepairLevel.platinum, "no comment");
                //s.addc("Jack", "Johnson");
                s.addo(2, new Date(3, 9, 2019), "Salsa", RepairLevel.silver, "no comment");
                s.addo(2, new Date(3, 8, 2019), "Jamis", RepairLevel.gold, "no comment");
                s.addo(2, new Date(3, 7, 2019), "Trek", RepairLevel.platinum, "no comment");
                //s.addc("Jill", "Johnson");
                s.addo(3, new Date(3, 6, 2019), "Cannondale", RepairLevel.silver, "no comment");
                s.addo(3, new Date(3, 5, 2019), "Salsa", RepairLevel.gold, "no comment");
                s.addo(3, new Date(3, 4, 2019), "Jamis", RepairLevel.platinum, "no comment");
                s.printworr();
	*/
